...
export interface DashboardDateStatusBase {
  ID?: number;
  Title?: string;
  Pillar?: string;
  StatusDate?: string;
...
export interface DashboardDateStatusRead extends DashboardDateStatusBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface DashboardDateStatusWrite extends DashboardDateStatusBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
