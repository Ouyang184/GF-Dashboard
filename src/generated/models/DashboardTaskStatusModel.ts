...
export interface DashboardTaskStatusBase {
  ID?: number;
  Title?: string;
  Type_Of_Task?: string;
...
export interface DashboardTaskStatusRead extends DashboardTaskStatusBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface DashboardTaskStatusWrite extends DashboardTaskStatusBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
