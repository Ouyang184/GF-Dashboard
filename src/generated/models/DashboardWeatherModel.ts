...
export interface DashboardWeatherBase {
  ID?: number;
  Title?: string;
  Temperature?: number;
  Condition?: string;
...
export interface DashboardWeatherRead extends DashboardWeatherBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface DashboardWeatherWrite extends DashboardWeatherBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
