...
export interface TargetPillarValue {
  "@odata.type": string;
  Value: string;
  Id: number;
}
...
export interface DashBoardControlBase {
  ID?: number;
  Title?: string;
  "Command#Id"?: number;
  "TargetPillar#Id"?: number;
  RequestedAt?: string;
  Active?: boolean;
...
export interface DashBoardControlRead extends DashBoardControlBase {
  Command?: CommandValue;
  TargetPillar?: TargetPillarValue;
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface DashBoardControlWrite extends DashBoardControlBase {
  Command?: string;
  TargetPillar?: string;
  Author?: AuthorValue;
  Editor?: EditorValue;
