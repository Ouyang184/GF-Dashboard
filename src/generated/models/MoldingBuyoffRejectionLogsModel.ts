...
export interface MoldingBuyoffRejectionLogsBase {
  ID?: number;
  Title?: string;
  PartNumber?: string;
  MachineNumber?: string;
  FirstRejectionDateTime?: string;
  LatestRejectionDateTime?: string;
  RejectionCount24Hours?: number;
  AlertStatus?: string;
...
export interface MoldingBuyoffRejectionLogsRead extends MoldingBuyoffRejectionLogsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface MoldingBuyoffRejectionLogsWrite extends MoldingBuyoffRejectionLogsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
